        ...
        <div class="footer">
            ...
            <div class="footer-bottom">
                <div class="footer-bottom--left">
                    <a href="#"><img class="footer-image" src="assets/imagens/instagram.png" alt="Instagram"></a>
                    <a href="#"><img class="footer-image" src="assets/imagens/facebook.png" alt="Facebook"></a>
                </div>
                <div>
                    &copy; 2024 FeiraGreen. Todos os direitos reservados.
                </div>
                <div class="footer-bottom--right">
                    <img class="footer-image" src="assets/imagens/mastercard.png" alt="Mastercard">
                    <img class="footer-image" src="assets/imagens/paypal.png" alt="PayPal">
                    <img class="footer-image" src="assets/imagens/visa.png" alt="Visa">
                </div>
            </div>
        </div>
    </footer>
